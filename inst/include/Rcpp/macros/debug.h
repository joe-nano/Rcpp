...
// simple logging help
    ...
    #define RCPP_DEBUG_MODULE( MSG ) {                                                                                             \
        ...
        if( mod__ ){                                                                                                                 \
            Rprintf( "[module (%s) <%p> ] %40s:%4d %s\n" , mod__->name.c_str(), mod__, short_file_name(__FILE__).c_str(), __LINE__, MSG ) ;\
        } else {                                                                                                                   \
    ...
    #define RCPP_DEBUG_MODULE_2( fmt, M1, M2 ) {                                                                                      \
        Rcpp::Module * mod__ = getCurrentScope() ;                                                                                 \
        if( mod__ ){                                                                                                                 \
            Rprintf( "[module (%s) <%p> ] %40s:%4d " fmt "\n" , mod__->name.c_str(), mod__, short_file_name(__FILE__).c_str(), __LINE__, M1, M2 ) ;\
        } else {                                                                                                                   \
            Rprintf( "[module () ] %40s:%4d " fmt "\n" , short_file_name(__FILE__).c_str(), __LINE__, M1, M2 ) ;                                \
        }                                                                                                                          \
    }
    #define RCPP_DEBUG_MODULE_3( fmt, M1, M2, M3 ) {                                                                                      \
        Rcpp::Module * mod__ = getCurrentScope() ;                                                                                 \
        if( mod__ ){                                                                                                                 \
            Rprintf( "[module (%s) <%p> ] %40s:%4d " fmt "\n" , mod__->name.c_str(), mod__, short_file_name(__FILE__).c_str(), __LINE__, M1, M2, M3 ) ;\
        } else {                                                                                                                   \
            Rprintf( "[module () ] %40s:%4d " fmt "\n" , short_file_name(__FILE__).c_str(), __LINE__, M1, M2, M3 ) ;                                \
        }                                                                                                                          \
    }
    #define RCPP_DEBUG_MODULE_4( fmt, M1, M2, M3, M4 ) {                                                                                      \
        Rcpp::Module * mod__ = getCurrentScope() ;                                                                                 \
        if( mod__ ) {                                                                                                                \
            Rprintf( "[module (%s) <%p> ] %40s:%4d " fmt "\n" , mod__->name.c_str(), mod__, short_file_name(__FILE__).c_str(), __LINE__, M1, M2, M3, M4 ) ;\
        } else {                                                                                                                   \
            Rprintf( "[module () ] %40s:%4d " fmt "\n" , short_file_name(__FILE__).c_str(), __LINE__, M1, M2, M3, M4 ) ;                                \
        }                                                                                                                          \
    }
    #define RCPP_DEBUG_MODULE_5( fmt, M1, M2, M3, M4, M5 ) {                                                                                      \
        Rcpp::Module * mod__ = getCurrentScope() ;                                                                                 \
        if( mod__ ){                                                                                                                 \
            Rprintf( "[module (%s) <%p> ] %40s:%4d " fmt "\n" , mod__->name.c_str(), mod__, short_file_name(__FILE__).c_str(), __LINE__, M1, M2, M3, M4, M5 ) ;\
        } else {                                                                                                                   \
            Rprintf( "[module () ] %40s:%4d " fmt "\n" , short_file_name(__FILE__).c_str(), __LINE__, M1, M2, M3, M4, M5 ) ;                                \
        }                                                                                                                          \
    }
